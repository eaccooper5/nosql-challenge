# nosql-challenge
## Repository for the nosql challenge
##### Erin Cooper

### Files

(NoSQL Repository)[https://github.com/eaccooper5/nosql-challenge.git]
...
## Collaboration
This project was completed by Erin Cooper with some help from Jeremy Cooper when troubleshooting query syntax, especially for the more complicated final two queries.
